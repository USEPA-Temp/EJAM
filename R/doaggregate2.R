...
#'
#'    Check if it includes Puerto Rico (no, that was dropped - but it is in blockroupstats for most fields though not race/ethnic subgroups)
#'  }
#'
...
#' @export
#'
doaggregate2 <- function(facilities, facilityblocks){
